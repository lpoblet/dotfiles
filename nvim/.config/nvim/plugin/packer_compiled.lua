...
_G.packer_plugins = {
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/leo/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/leo/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/leo/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
